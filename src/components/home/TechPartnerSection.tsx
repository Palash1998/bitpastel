      ...
      <section className="pt-12 lg:pt-16 ">
        <div className="mx-auto ">
          <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-6 ">
            <div
              className="rounded-tr-[40px] rounded-br-[40px] overflow-hidden md:mr-0 mr-4 min-h-[15rem] md:min-h-full"
            >
              <Image
            ...
            <div className="md:ml-0 ml-4 bg-primary-mint lg:p-12 md:p-12 py-10 px-6 rounded-tl-[40px] rounded-bl-[40px] content-center overflow-hidden">

      ...
      <div className="container mx-auto px-4">
        <div className="relative md:rounded-2xl overflow-hidden">
          ...
          <div 
            ...
            style={{ backgroundImage: "url('/images/descoder_Desktop.png')" }}
          ></div>
          ...
          <div className="relative px-[16px] md:py-[130px] py-[60px] lg:px-[66px]">
            <div className="lg:max-w-[520px] md:max-w-[480px] max-w-[290px]">
              ...
              <button className="btn leading-normal md:w-auto w-[200px]  text-[rgba(30,30,30,1)] bg-[rgba(255,255,255,1)] hover:text-white hover:bg-primary-teal transition-colors duration-200 font-inter">
                Contact Us
              </button>
            </div>
          </div>
